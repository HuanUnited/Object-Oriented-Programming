...
struct _Scratch_list : _List_node_base {
  ...
  struct _Ptr_cmp {
    ...
    bool operator()(__detail::_List_node_base* __lhs,
  ...
  void merge(_List_node_base& __x, _Cmp __comp) {
    ...
    if (__first2 != __last2) this->_M_transfer(__first2, __last2);
  }
  ...
  void _M_put_all(_List_node_base* __i) {
    if (!empty()) __i->_M_transfer(_M_next, this);
  }
};
...
list(_InputIterator, _InputIterator,
     _Allocator = _Allocator()) -> list<_ValT, _Allocator>;
#endif
